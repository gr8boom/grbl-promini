...
#define cpu_map_h
...
#ifdef CPU_MAP_ATMEGA328P // (Arduino ProMini) Officially supported by Grbl.
  ...
  #define X_STEP_BIT      2  // ProMini Digital Pin 2
  #define Y_STEP_BIT      3  // ProMini Digital Pin 3
  #define Z_STEP_BIT      4  // ProMini Digital Pin 4
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

  // Define step direction output pins. NOTE: All direction pins must be on the same port.
  #define DIRECTION_DDR     DDRD
  #define DIRECTION_PORT    PORTD
  #define X_DIRECTION_BIT   7  // ProMini Digital Pin 5
  #define Y_DIRECTION_BIT   6  // ProMini Digital Pin 6
  #define Z_DIRECTION_BIT   5  // ProMini Digital Pin 7
  #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits

  // Define stepper driver enable/disable output pin.
  #define STEPPERS_DISABLE_DDR    DDRB
  #define STEPPERS_DISABLE_PORT   PORTB
  #define STEPPERS_DISABLE_BIT    0  // ProMini Digital Pin 8
  ...
  #define X_LIMIT_BIT      1  // ProMini Digital Pin 9
  #define Y_LIMIT_BIT      2  // ProMini Digital Pin 10
  #ifdef VARIABLE_SPINDLE // Z Limit pin and spindle enabled swapped to access hardware PWM on Pin 11.
    #define Z_LIMIT_BIT	   4 // ProMini Digital Pin 12
  #else
    #define Z_LIMIT_BIT    3  // ProMini Digital Pin 11
  #endif
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
        ...
        #define SPINDLE_ENABLE_BIT    5  // ProMini Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)
      #else
        #define SPINDLE_ENABLE_BIT    3  // ProMini Digital Pin 11
      #endif
    #else
      #define SPINDLE_ENABLE_BIT    4  // ProMini Digital Pin 12
    #endif
    #ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
      #define SPINDLE_DIRECTION_DDR   DDRB
      #define SPINDLE_DIRECTION_PORT  PORTB
      #define SPINDLE_DIRECTION_BIT   5  // ProMini Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)
    #endif
    ...
    #define SPINDLE_PWM_BIT   3    // ProMini Digital Pin 11
    ...
    // the spindle direction and optional coolant mist pins.
      ...
      // NOTE: Coolant flood moved from A3 to A4. Coolant mist not supported with dual axis feature on Arduino ProMini.
      #define COOLANT_FLOOD_DDR   DDRB
      #define COOLANT_FLOOD_PORT  PORTB
      #define COOLANT_FLOOD_BIT   5  // ProMini Digital Pin 13
    ...
    // NOTE: Variable spindle not supported with this shield.
      ...
      #define DUAL_STEP_BIT       4  // ProMini Digital Pin 12
      #define STEP_MASK_DUAL      ((1<<DUAL_STEP_BIT))
      #define DIRECTION_DDR_DUAL  DDRB
      #define DIRECTION_PORT_DUAL PORTB
      #define DUAL_DIRECTION_BIT  5  // ProMini Digital Pin 13
      #define DIRECTION_MASK_DUAL ((1<<DUAL_DIRECTION_BIT))
      ...
      #define COOLANT_FLOOD_DDR   DDRC
      #define COOLANT_FLOOD_PORT  PORTC
      #define COOLANT_FLOOD_BIT   4  // ProMini Analog Pin 4

      // Define spindle enable output pin.
      // NOTE: Spindle enable moved from D12 to A3 (old coolant flood enable pin). Spindle direction pin is removed.
      #define SPINDLE_ENABLE_DDR    DDRC
      #define SPINDLE_ENABLE_PORT   PORTC
      #define SPINDLE_ENABLE_BIT    3  // ProMini Analog Pin 3
    #endif
